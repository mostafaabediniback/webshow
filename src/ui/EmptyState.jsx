...
const EmptyState = ({
  ...
  message,
  icon = (
    <PlayCircle size={40} className="text-orange-500" color="currentColor" />
  ),
  action,
  className = "",
}) => {
  return (
    <div
      className={`flex flex-col items-center justify-center py-20 px-4 rounded-2xl bg-slate-50 border border-slate-200 border-dashed ${className}`}
    >
