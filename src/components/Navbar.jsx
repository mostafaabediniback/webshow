...
import { Menu, SearchNormal1, VideoAdd, Notification, User, CloseCircle } from 'iconsax-react'
...
<div className='max-w-7xl w-full mx-auto flex justify-center items-center'>
          ...
          <div className="hidden md:flex items-center gap-3 ">
            ...
            <button className="p-2.5 rounded-lg hover:bg-gray-100 active:bg-gray-200 transition-colors text-slate-900 relative" title="اعلان‌ها">
              <Notification size={22} color="#0f172a" />
              <span className="absolute top-1 right-1 w-2 h-2 bg-red-500 rounded-full"></span>
            </button>
            <Link to="/login" className="h-10 px-4 rounded-full border border-gray-300 bg-white hover:bg-gray-50 active:bg-gray-100 text-sm font-medium flex items-center gap-2 text-slate-900 transition-colors shadow-sm hover:shadow">
